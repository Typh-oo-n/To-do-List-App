defmodule MytodoWeb.Router do
  ...
  if Application.compile_env(:mytodo, :dev_routes) do
  ...
  scope "/", MytodoWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{MytodoWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", MytodoWeb do
    ...
    live_session :current_user,
      on_mount: [{MytodoWeb.UserAuth, :mount_current_user}] do
